...
export const metadata: Metadata = {
  ...
  description: 'Digital product designer in Saudi Arabia working across UI/UX, web design, systems thinking, responsive interfaces, AI-assisted workflows, and implementation-aware delivery.',
  alternates: {
    canonical: '/en',
  ...
  openGraph: {
    url: '/en',
    title: 'Ibrahim — Digital Product & Experience Designer',
    description: 'Complex systems. Clear digital experiences — through UX, web design, systems thinking, and AI-assisted delivery.',
  },
};
  ...
  return (
    <main id="main" className="cvPage cvV3">
      <div className="cvFrame">
        <HomeHeader locale="en" counterpartHref="/" hasWork={hasWork} />
